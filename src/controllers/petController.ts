...
import { PetRequest, petRequestSchema } from '../models/petRequest.js';
import { Status2Enum, status2EnumSchema } from '../models/status2Enum.js';
...
export class PetController extends BaseController {
  ...
  async updatePetWithForm(
    ...
    req.form({ name: mapped.name, status: mapped.status });
    req.appendTemplatePath`/pet/${mapped.petId}`;
  ...
  async addPet(
    ...
    const mapped = req.prepareArgs({ body: [body, petRequestSchema] });
  ...
  async uploadFile(
    ...
    req.formData({ additionalMetadata: mapped.additionalMetadata, file: file });
  ...
  async findPetsByTags(
    ...
    req.deprecated('PetController.findPetsByTags');
