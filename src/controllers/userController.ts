...
import { UserRequest, userRequestSchema } from '../models/userRequest.js';
...
export class UserController extends BaseController {
  ...
  async createUser(
    ...
    const mapped = req.prepareArgs({ body: [body, userRequestSchema] });
    req.header('Content-Type', 'application/json');
    req.json(mapped.body);
    req.authenticate([]);
    return req.call(requestOptions);
  ...
  async createUsersWithArrayInput(
    ...
    const req = this.createRequest('POST', '/user/createWithArray');
    const mapped = req.prepareArgs({ body: [body, array(userSchema)] });
    req.header('Content-Type', 'application/json');
    req.json(mapped.body);
    req.authenticate([]);
