...
use SwaggerPetstoreLib\Models\ContentTypeEnum;
...
class PetController extends BaseController
{
     ...
     *
     * @param PetRequest $body Pet object that needs to be added to the store
     *
     * @return void Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function addPet(PetRequest $body): void
    {
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function updatePet(PetRequest $body): void
    {
