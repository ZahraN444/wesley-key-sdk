...
class SwaggerPetstoreClientBuilder
{
    /**
     * @var array
     */
    ...
    public function testHeader(string $testHeader): self
    {
        $this->config['testHeader'] = $testHeader;
        return $this;
    }
    ...
    public function httpBasicCredentials(HttpBasicCredentialsBuilder $httpBasic): self
    {
        $this->config = array_merge($this->config, $httpBasic->getConfiguration());
        return $this;
    }
    ...
    public function build(): SwaggerPetstoreClient
    {
        return new SwaggerPetstoreClient($this->config);
    }
}
