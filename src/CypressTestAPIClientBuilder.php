...
class CypressTestAPIClientBuilder
{
    /**
     * @var array
     */
    ...
    public function defaultHost(string $defaultHost): self
    {
        $this->config['defaultHost'] = $defaultHost;
        return $this;
    }
    ...
    public function build(): CypressTestAPIClient
    {
        return new CypressTestAPIClient($this->config);
    }
}
