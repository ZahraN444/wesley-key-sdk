...
class OAuthProviderException extends ApiException
{
    ...
    /**
     * @param string $reason
     * @param \SwaggerPetstoreLib\Http\HttpRequest $request
     * @param \SwaggerPetstoreLib\Http\HttpResponse $response
     * @param string $error
     */
    public function __construct(
        string $reason,
        \SwaggerPetstoreLib\Http\HttpRequest $request,
        \SwaggerPetstoreLib\Http\HttpResponse $response,
        string $error
    ) {
     ...
     * @required
     * @maps error
     * @factory \SwaggerPetstoreLib\Models\OAuthProviderErrorEnum::checkValue
     */
