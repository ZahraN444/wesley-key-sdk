...
class PetRequest implements \JsonSerializable
{
    /**
     * @var int|null
     */
     ...
     * @maps category
     */
    public function setCategory(?Category2 $category): void
    {
    ...
    /**
     * Converts the PetRequest object to a human-readable string representation.
     *
     * @return string The string representation of the PetRequest object.
     */
