...
The following example uses `Monolog\Logger` implementation of `Psr\Log\LoggerInterface` for WebhooksAndCallbacksAPIClient initialization.
...
$logger = new Logger('WebhooksAndCallbacksAPI');
