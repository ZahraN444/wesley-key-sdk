...
This event's request payload is of type [array<string,string>].
...
Route::post(
    ...
    function (Request $request): Response {
        ...
        } elseif (is_array($result) && is_string(array_values($result)[0])) {
            return response("Received an event of type array<string,string>: $result");
