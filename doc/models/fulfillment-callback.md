...
| `orderIdd` | `?string` | Optional | - | getOrderIdd(): ?string | setOrderIdd(?string orderIdd): void |
| `fulfillmentStatuss` | [`?string(FulfillmentStatuss)`](../../doc/models/fulfillment-statuss.md) | Optional | - | getFulfillmentStatuss(): ?string | setFulfillmentStatuss(?string fulfillmentStatuss): void |
| `trackingNumberr` | `?string` | Optional | - | getTrackingNumberr(): ?string | setTrackingNumberr(?string trackingNumberr): void |
| `carrierr` | `?string` | Optional | - | getCarrierr(): ?string | setCarrierr(?string carrierr): void |
| `scopess` | [`?(string(OauthScopeOauthACG)[])`](../../doc/models/oauth-scope-oauth-acg.md) | Optional | List of scopes that apply to the OAuth token<br><br>**Constraints**: *Unique Items Required* | getScopess(): ?array | setScopess(?array scopess): void |
| `estimatedDeliveryy` | `?DateTime` | Optional | - | getEstimatedDeliveryy(): ?\DateTime | setEstimatedDeliveryy(?\DateTime estimatedDeliveryy): void |
| `timestampp` | `?DateTime` | Optional | - | getTimestampp(): ?\DateTime | setTimestampp(?\DateTime timestampp): void |
| `documentt` | `?string` | Optional | Binary file upload | getDocumentt(): ?string | setDocumentt(?string documentt): void |
